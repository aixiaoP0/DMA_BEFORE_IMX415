...
//创建一个线程池，最大线程数为12
ThreadPool gthreadpool(model_path,12);
// 定义一个静态变量，用于记录帧的起始ID
...
{
//1.测试图像
 char img_path[] = "/home/radxa/chapter1/person.jpg";
...
Yolov5s yolov5s("/home/radxa/chapter1/model/yolov5s.rknn", 1);
// detect_result_group_t result_group;
// yolov5s.inference_image(img2,&result_group);
// yolov5s.draw_result(img2,&result_group);
// imwrite("img2_detect.jpg",img2);
// post_process();
// while(1);
